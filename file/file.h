...
// stolen from https://github.com/stoneharry/Blizzard-Updater/blob/master/src/file.hpp
...
public:
  ...
  void write_from (FileBuffer *data) const
  {
      fwrite (data->ptr(), data->size(), 1, _handle);
  }
